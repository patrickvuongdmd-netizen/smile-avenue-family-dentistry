          ...
          <div className="container mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-10 max-w-3xl mx-auto text-left">
              ...
              <div className="bg-card rounded-xl p-6 border border-border">
                ...
                <a href="https://book.modento.io/c/7e879f019b1846dda0dde08e10b56c25/SmileAvenueKaty" target="_blank" rel="noopener noreferrer" className="btn-cta text-center w-full">Book at Katy</a>
              </div>
            </div>
          </div>
        </section>
