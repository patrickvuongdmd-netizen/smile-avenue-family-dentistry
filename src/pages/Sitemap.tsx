...
const sections = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Bone Grafting", href: "/cypress-tx/bone-grafting" },
      { label: "Gum Disease Treatment", href: "/cypress-tx/gum-disease-treatment" },
      { label: "Wisdom Teeth Removal", href: "/cypress-tx/wisdom-teeth" },
      { label: "Dental Bonding", href: "/cypress-tx/dental-bonding" },
      { label: "Smile Makeover", href: "/cypress-tx/smile-makeover" },
      { label: "Gum Recession Treatment", href: "/cypress-tx/gum-recession-treatment" },
      { label: "Family Dentistry", href: "/cypress-tx/family-dentistry" },
      { label: "General Dentistry", href: "/cypress-tx/general-dentistry" },
    ],
  },
  {
    title: "Services — Katy",
    links: [
      ...
      { label: "Bone Grafting", href: "/katy-tx/bone-grafting" },
      { label: "Gum Disease Treatment", href: "/katy-tx/gum-disease-treatment" },
      { label: "Wisdom Teeth Removal", href: "/katy-tx/wisdom-teeth" },
      { label: "Dental Bonding", href: "/katy-tx/dental-bonding" },
      { label: "Smile Makeover", href: "/katy-tx/smile-makeover" },
      { label: "Gum Recession Treatment", href: "/katy-tx/gum-recession-treatment" },
      { label: "Family Dentistry", href: "/katy-tx/family-dentistry" },
      { label: "General Dentistry", href: "/katy-tx/general-dentistry" },
    ],
  },
  {
    title: "Doctors",
