...
const doctors = [
  { name: "Dr. Patrick Vuong", credentials: "DMD", title: "Founder", tagline: "Comprehensive, patient-centered implant and digital dentistry", locations: "Cypress & Katy", slug: "patrick-vuong-dmd" },
  { name: "Dr. Peter Kim", credentials: "DDS", title: "General Dentist", tagline: "Known for gentle approach and patient comfort", locations: "Cypress", slug: "peter-kim-dds" },
  { name: "Dr. Laith Yahya", credentials: "DDS", title: "General Dentist", tagline: "Integrity, precision & passion for restorative care", locations: "Cypress & Katy", slug: "laith-yahya-dds" },
  { name: "Dr. Weiyen Chang", credentials: "DDS", title: "General Dentist", tagline: "Technology-driven dentistry", locations: "Katy", slug: "weiyen-chang-dds" },
  { name: "Dr. Christian Lopez", credentials: "DDS", title: "General Dentist", tagline: "Dedicated to compassionate, high-quality care", locations: "Katy", slug: "christian-lopez-dds" },
  { name: "Dr. Tamaara Willis", credentials: "DDS, MS", title: "Specialist", tagline: "Advanced specialty training with MS credential", locations: "Both Locations", slug: "tamaara-willis-dds-ms" },
];
