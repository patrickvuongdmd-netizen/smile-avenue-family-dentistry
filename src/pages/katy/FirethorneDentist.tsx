...
const data: NeighborhoodPageData = {
  ...
  metaDescription: "Firethorne dentist on Westheimer Pkwy in Katy, TX. Same-day & Saturday appointments. Implants, Invisalign & emergency care. 4.9★. Call (281) 800-5008.",
