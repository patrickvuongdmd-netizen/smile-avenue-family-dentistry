...
const data: LandingPageData = {
  ...
  benefits: [
    ...
    { icon: <Clock className="w-6 h-6" />, title: "Open Saturdays", description: "Our Katy office is open Saturday mornings for urgent care — because emergencies don't wait for weekdays." },
  ],
  faqs: [
  ...
  finalCtaBody: "Same-day emergency appointments at Smile Avenue Katy. We'll get you out of pain fast.",
};
