...
const data: LandingPageData = {
  ...
  heroSubheadline: "Severe toothache, broken tooth, or knocked-out tooth? Same-day emergency appointments in Cypress. Walk-ins welcome — call now and we'll get you out of pain fast.",
  heroCtaLabel: "Call Now — Get Seen Today",
  heroCtaType: "call",
  isEmergency: true,
  heroReassurance: "Average wait time: under 30 minutes · Walk-ins welcome · Most insurance accepted",
  benefits: [
  ...
  finalCtaBody: "Same-day emergency appointments at Smile Avenue Cypress. We'll get you out of pain fast — no referral needed.",
};
