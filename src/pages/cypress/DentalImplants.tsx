      ...
      <section className="section-padding section-alt">
        <div className="container mx-auto max-w-3xl">
          ...
          <div className="space-y-4 font-body text-base text-muted-foreground leading-relaxed">
            <p>A dental implant is a small titanium post that is surgically placed into the jawbone to serve as an artificial tooth root. Once the implant integrates with the bone — a process called osseointegration — a custom-made crown is attached, creating a restoration that is virtually indistinguishable from a natural tooth.</p>
            <p>Unlike bridges or dentures, implants don't rely on neighboring teeth for support. They stimulate the jawbone just like natural roots, preventing the bone loss that typically follows tooth loss. This makes implants not just a cosmetic solution, but a long-term investment in your oral health.</p>
            <p>At Smile Avenue Cypress, we also offer full-arch solutions like All-on-4 and All-on-6 implants for patients missing most or all of their teeth. These advanced techniques can restore an entire arch of teeth with as few as four strategically placed implants.</p>
          </div>
        </div>
      </section>
