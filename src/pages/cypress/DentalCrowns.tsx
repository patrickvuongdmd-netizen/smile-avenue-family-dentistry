...
const DentalCrownsCypress = () => (
  <>
    ...
    <main className="pb-14 lg:pb-0">
      ...
      <section className="section-padding section-alt"><div className="container mx-auto max-w-3xl"><p className="kicker">RESTORE & PROTECT</p><h2 className="section-heading">What Are Dental Crowns?</h2><div className="space-y-4 font-body text-base text-muted-foreground leading-relaxed"><p>A dental crown is a custom-made cap that fits over a damaged, decayed, or weakened tooth to restore its shape, size, strength, and appearance. Crowns are one of the most common and versatile restorations in dentistry — often placed after a <Link to="/cypress-tx/root-canal" className="text-primary hover:underline">root canal</Link> or on top of a <Link to="/cypress-tx/dental-implants" className="text-primary hover:underline">dental implant</Link>.</p><p>At Smile Avenue Cypress, we're proud to offer CEREC same-day crown technology. Using digital scanning and in-office milling, we can create a precise, high-quality ceramic crown while you wait — eliminating the need for messy impressions, temporary crowns, and a second appointment weeks later. We also offer <Link to="/cypress-tx/dental-bridges" className="text-primary hover:underline">dental bridges</Link> for patients missing multiple adjacent teeth.</p></div></div></section>
