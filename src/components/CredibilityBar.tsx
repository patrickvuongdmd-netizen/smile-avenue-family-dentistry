...
const GOOGLE_REVIEWS_URL = "https://www.google.com/maps/place/Smile+Avenue+Family+Dentistry+-+Cypress/@29.916882,-95.7273261,17z/data=!4m8!3m7!1s0x8640d626dcbf8be7:0xc78b697f2e5a6c9c!8m2!3d29.916882!4d-95.7247512!9m1!1b1!16s%2Fg%2F11h1v3bk5q";
  ...
  <section className="py-6 md:py-14 bg-muted/50">
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
      ...
      <a
        ...
        className="inline-flex items-center gap-3 bg-card rounded-full border border-border/60 px-5 py-3 mb-5 md:mb-8 shadow-sm hover:shadow-md hover:border-primary/30 transition-all"
      >
        ...
        <div className="flex flex-col items-start">
          <div className="flex items-center gap-1">
            <span className="text-sm font-sans font-bold text-foreground">4.9</span>
            <div className="flex gap-px">{[...Array(5)].map((_, i) => <Star key={i} className="w-3 h-3 fill-[#FBBC05] text-[#FBBC05]" />)}</div>
          </div>
          <span className="text-[11px] font-sans text-muted-foreground">5,000+ Google Reviews</span>
        </div>
      </a>
