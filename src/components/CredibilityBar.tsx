...
const platforms = [
  { name: "Google", stat: "4.9 Stars · 5,000+ Reviews", mobileOnly: true, icon: (
  ...
  { name: "Yelp", stat: "192 Reviews", mobileOnly: false, icon: (
  ...
  { name: "Facebook", stat: "1,300+ Community", mobileOnly: false, icon: (
  ...
  { name: "Instagram", stat: "12K Followers", mobileOnly: false, icon: (
  ...
  { name: "YouTube", stat: "25.6K Subscribers", mobileOnly: true, icon: (
