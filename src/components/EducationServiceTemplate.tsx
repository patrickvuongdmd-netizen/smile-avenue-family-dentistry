  ...
  return (
    <>
      ...
      <main id="main-content" className="pb-14 lg:pb-0">
          ...
          <div className="container mx-auto">
            <div className="max-w-3xl mx-auto">
              ...
              <div className="card-warm p-8 md:p-10">
                <p className="font-body text-lg text-muted-foreground leading-relaxed">{data.costNote}</p>
                <div className="mt-8 flex flex-wrap gap-3">
                  <Link to="/insurance" className="btn-secondary text-sm">Insurance & Financing →</Link>
                  <Link to="/membership-plan" className="text-sm font-sans font-semibold text-primary hover:underline flex items-center gap-1 py-2 px-4">
                    No Insurance? See Our Membership Plan <ArrowRight className="w-3.5 h-3.5" />
                  </Link>
                </div>
              </div>
            </div>
        ...
        {/* COMPARISON TABLE — Smile Avenue vs Typical Office */}
        <section className="px-4 sm:px-6 lg:px-8 py-24 md:py-28 section-warm">
          <div className="container mx-auto text-center">
        ...
        <section className="px-4 sm:px-6 lg:px-8 py-24 md:py-28 bg-background">
          <div className="container mx-auto text-center">
            <p className="kicker">AVAILABLE AT BOTH LOCATIONS</p>
            <h2 className="section-heading">Find {data.serviceName} Near You</h2>
            <p className="section-body max-w-2xl mx-auto">
              {data.serviceName} is offered at both our Cypress and Katy offices. Choose the location most convenient for you.
            </p>
