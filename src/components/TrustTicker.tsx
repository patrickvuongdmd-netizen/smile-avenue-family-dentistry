...
const TrustTicker = () => {
  ...
  return (
    <div className="overflow-hidden flex relative bg-muted/60 border-b border-border/40 transition-all duration-300 [[data-menu-open]_&]:h-0 [[data-menu-open]_&]:overflow-hidden [[data-menu-open]_&]:opacity-0">
