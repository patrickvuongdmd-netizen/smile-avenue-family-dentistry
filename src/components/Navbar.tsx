      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 md:h-20">
          ...
          <Link to="/" className="absolute left-1/2 -translate-x-1/2 md:static md:translate-x-0 flex items-center shrink-0">
            ...
            <img src="/logo-full-alt.webp" alt="Smile Avenue Family Dentistry" <img src="/logo-full-alt.webp" alt="Smile Avenue Family Dentistry" className="md:hidden h-11 w-auto object-contain" width={200} height={155} /> width={200} height={155} />
          </Link>
