...
export const TEAM_MEMBERS = {
  ...
  assistants: [
    ...
    { name: "London Robinson", credentials: "RDA", role: "Dental Assistant", locations: ["Cypress", "Katy"], imgKey: "" },
    { name: "Stephanie Tabora", credentials: "RDA", role: "Dental Assistant", locations: ["Cypress"], imgKey: "" },
    { name: "Tania Hernandez", credentials: "RDA", role: "Dental Assistant", locations: ["Cypress", "Katy"], imgKey: "" },
