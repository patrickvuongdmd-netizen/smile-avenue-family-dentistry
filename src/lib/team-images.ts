...
import danielRodriguez from "@/assets/team/daniel-rodriguez.png";
import dianaOrtiz from "@/assets/team/diana-ortiz.png";
import duaaShawkat from "@/assets/team/duaa-shawkat.png";
import emmanuelJaimes from "@/assets/team/emmanuel-jaimes.png";
...
export const TEAM_IMAGES: Record<string, { url: string; alt: string }> = {
  ...
  "emmanuel-jaimes": { url: emmanuelJaimes, alt: "Emmanuel Jaimes, Office Manager at Smile Avenue Family Dentistry Katy TX" },
  ...
  "whitney-darden": { url: whitneyDarden, alt: "Whitney Darden, RDA - Dental Assistant at Smile Avenue Family Dentistry Katy TX" },
};
